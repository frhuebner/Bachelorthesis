...
%friedrich \usepackage[backend=bibtex, hyperref=true, style=numeric-comp, sorting=none, block=ragged, firstinits=true]{biblatex}
...
\input{chapter/qft.tex}
\input{chapter/qft_spacetime.tex}
\input{chapter/bh.tex}

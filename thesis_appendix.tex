%------------------------------------------------------------------------------
\chapter{Wightman function and Unruh detector}
\label{sec:app}
\begin{refsection}
%------------------------------------------------------------------------------
...
%	
[\sqrt{g/\beta} \partial_t \phi(\vb{x}), \sqrt{g/\beta} \partial_t \phi(0)] &= \int \frac{\dd[3]{k}}{(2\pi)^3} \frac{|\va{k}|}{2 N_{\va{k}}}\tilde{u}_{\va{k}}(\vb{x}) \tilde{u}_{\va{k}}(0)^* - \frac{|\va{k}|}{2 N_{\va{k}}}\tilde{u}_{\va{k}}(\vb{x})^* \tilde{u}_{\va{k}}(0)  + \order{x^2}\\
	&= i \int \frac{\dd[3]{k}}{(2\pi)^3} \frac{|\va{k}|}{2 N_{\va{k}}} e^{i \va{k}\va{x} + \order*{x^2}} - \frac{|\va{k}|}{2 N_{\va{k}}}e^{-i \va{k}\va{x} + \order*{x^2}} + \order{x^2} \overset{!}{=} 0
\end{align}
\begin{align}
[\phi(\vb{x}), \sqrt{g/\beta} \partial_t \phi(0)] &= i \int \frac{\dd[3]{k}}{(2\pi)^3} \frac{1}{2N_{\va{k}}}\tilde{u}_{\va{k}}(\vb{x}) \tilde{u}_{\va{k}}(0)^* + \frac{1}{2N_{\va{k}}}\tilde{u}_{\va{k}}(\vb{x})^* \tilde{u}_{\va{k}}(0) + \order{x^2}\\
